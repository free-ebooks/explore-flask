# -*- coding: utf-8 -*-
#
# Explore Flask documentation build configuration file, created by
# sphinx-quickstart on Sun Jun  1 13:47:36 2014.
#
...
project = u'Explore Flask'
copyright = u'2014, Robert Picard'
...
htmlhelp_basename = 'ExploreFlaskdoc'
...
latex_documents = [
  ('index', 'ExploreFlask.tex', u'Explore Flask Documentation',
   u'Robert Picard', 'manual'),
]
...
man_pages = [
    ('index', 'exploreflask', u'Explore Flask Documentation',
     [u'Robert Picard'], 1)
]
...
texinfo_documents = [
  ('index', 'ExploreFlask', u'Explore Flask Documentation',
   u'Robert Picard', 'ExploreFlask', 'One line description of project.',
   'Miscellaneous'),
]
